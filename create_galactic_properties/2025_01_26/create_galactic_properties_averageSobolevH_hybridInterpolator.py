...
def main(redshift):
    ...
    file_path = f"{save_dir}/galactic_properties_averageSobolevH_hybridInterpolator_z{int(float(redshift))}_usingIvalues_2.csv"
...
def get_galactic_properties_for_a_galaxy(galaxy_name:str, galaxy_type:str, redshift:str, directory_name:str):
    ...
    # file_name_lines = "L_line_averageSobolevH_nearestNDInterpolator_flux2Luminosity.txt"
    file_name_lines = "L_line_averageSobolevH_hybridInterpolator_flux2Luminosity_2.txt"
    ...
    # other_properties_file_name = "otherProperties_averageSobolevH_nearestNDInterpolator.txt"
    other_properties_file_name = "otherProperties_averageSobolevH_hybridInterpolator_2.txt"
    ...
    semi_analytical_file_name = "semi_analytical_averageSobolevH_cf_1.txt"
