...
def main(gas_particles, star_particles, header_info, galaxy_type, galaxy_name, snapshot_number=None):
    ...
    if galaxy_type == "zoom_in_tolgay":
        plt.savefig(f"/mnt/raid-cita/dtolgay/FIRE/post_processing_fire_outputs/skirt/runs_hden_radius/zoom_in/z{round(redshift,1)}/images/{galaxy_name}_{R_max}.png")
        print(f"Figure saved to: /mnt/raid-cita/dtolgay/FIRE/post_processing_fire_outputs/skirt/runs_hden_radius/zoom_in/z{round(redshift,1)}/images/{galaxy_name}_{R_max}.png")          
    else:
        plt.savefig(f"/mnt/raid-cita/dtolgay/FIRE/post_processing_fire_outputs/skirt/runs_hden_radius/{galaxy_type}/z{round(redshift,1)}/images/{galaxy_name}_{R_max}.png")
        print(f"Figure saved to: /mnt/raid-cita/dtolgay/FIRE/post_processing_fire_outputs/skirt/runs_hden_radius/{galaxy_type}/z{round(redshift,1)}/images/{galaxy_name}_{R_max}.png")    
