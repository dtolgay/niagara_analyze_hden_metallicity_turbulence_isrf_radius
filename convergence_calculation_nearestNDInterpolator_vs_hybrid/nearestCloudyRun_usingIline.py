...
def main(galaxy_name, galaxy_type, redshift):
    ...
    cloudy_gas_particles_file_directory = f"/scratch/m/murray/dtolgay/cloudy_runs/z_0/m12f_res7100_md_test"

    write_file_path = f"{cloudy_gas_particles_file_directory}/L_line_averageSobolevH_nearestCloudyRun_intensity2Luminosity_groundTruth.txt"
    ...
    train_data_main_directory_1 = "m12f_res7100_md_test" 
    ...
    # 2nd set of run
    train_data_df_2 = pd.DataFrame()
    train_data_base_file_dir_2 = ""
    train_data_main_directory_2 = "" 
    ######### 
