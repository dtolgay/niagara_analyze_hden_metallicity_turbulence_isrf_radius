...
def main(galaxy_name, galaxy_type, redshift, max_workers, write_interpolator_info=False):
    ...
    write_file_path = f"{cloudy_gas_particles_file_directory}/L_line_averageSobolevH_hybridInterpolator_flux2Luminosity_metallicity_mult_10^1.48.txt"
...
def read_cloudy_gas_particles(cloudy_gas_particles_file_directory):
    ...
    ### Change metallicity
    gas_particles_df['metallicity'] *= 10**1.48
