...
def main(galaxy_name, galaxy_type, redshift):
    ...
    write_file_path = f"{cloudy_gas_particles_file_directory}/L_line_averageSobolevH_nearestCloudyRun_intensity2Luminosity_isrfDividedBy20_fixedSolarMetallicity.txt"
...
def read_cloudy_gas_particles(cloudy_gas_particles_file_directory):
    ...
    # TODO: Done for testing purposses. I will check how artificial reduction in the ISRF will affect the line luminosities. 
    gas_particles_df['isrf'] /= 20 

    # TODO: Set the metallicity to solar 
    gas_particles_df['metallicity'] = 1   # Set everything to Zsolar
