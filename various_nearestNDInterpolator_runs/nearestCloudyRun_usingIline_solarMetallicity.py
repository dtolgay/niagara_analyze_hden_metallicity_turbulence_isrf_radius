...
def main(galaxy_name, galaxy_type, redshift):
    ...
    write_file_path = f"{cloudy_gas_particles_file_directory}/L_line_averageSobolevH_nearestCloudyRun_intensity2Luminosity_fixedSolarMetallicity.txt"
...
def read_cloudy_gas_particles(cloudy_gas_particles_file_directory):
    ...
    # TODO: Set everything to solar metallicitys
