...
if __name__ == "__main__":
    ...
    interpolators = {
        "temperature": {
            ...
            # "write_file_name": f"temperature_smoothingLength_{interpolator_name}_recreated",
        ...
        "line_emissions": {
            ...
            # "write_file_name": f"line_emissions_smoothingLength_{interpolator_name}_recreated",
        ...
        "abundance": {
            ...
            # "write_file_name": f"abundance_smoothingLength_{interpolator_name}_recreated",
    ...
    files_info = {
        "write_file_name": f"{gas_particles_path}/{interpolator_target_type}_{interpolator_name}_smoothingLength_recreated.txt",
